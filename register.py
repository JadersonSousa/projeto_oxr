...
class Register:
    def __init__(self, frame_cadastros):
        ...
        # DADOS #
        ## Dados Usuários ##
        self.dados_CadUser = ttk.Treeview(self.frame_CadUser, height=4, columns=("col1", "col2", "col3", "col4"))

        self.dados_CadUser.heading("#0", text="Usuário")
        self.dados_CadUser.heading("#1", text="Login")
        self.dados_CadUser.heading("#2", text="Senha")
        self.dados_CadUser.heading("#3", text="Gerência")

        self.dados_CadUser.column("#0", width=300)
        self.dados_CadUser.column("#1", width=300)
        self.dados_CadUser.column("#2", width=200)
        self.dados_CadUser.column("#3", width=200)
        ...
        ## Dados Empresa ##
        self.dado_CadEmp = ttk.Treeview(self.frame_CadEmp, height=2, columns=("col1", "col2"))

        self.dado_CadEmp.heading("#0", text="ID")
        self.dado_CadEmp.heading("#1", text="Empresa")

        self.dado_CadEmp.column("#0", width=50)
        self.dado_CadEmp.column("#1", width=500)
        self.dado_CadEmp.column("#2", width=500)
        ...
        ## Dados Filial ##
        self.dado_CadFil = ttk.Treeview(self.frame_CadFil, height=2, columns=("col1", "col2"))

        self.dado_CadFil.heading("#0", text="FL")
        self.dado_CadFil.heading("#1", text="Filial")

        self.dado_CadFil.column("#0", width=50)
        self.dado_CadFil.column("#1", width=500)
        ...
        self.dado_CadCdc = ttk.Treeview(self.frame_CadCdc, height=3, columns=("col1", "col2", "col3"))

        self.dado_CadCdc.heading("#0", text="CC")
        self.dado_CadCdc.heading("#1", text="Centro de Custos")
        self.dado_CadCdc.heading("#2", text="Gerência")

        self.dado_CadCdc.column("#0", width=50)
        self.dado_CadCdc.column("#1", width=500)
        self.dado_CadCdc.column("#2", width=150)
