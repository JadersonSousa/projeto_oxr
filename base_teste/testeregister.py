...
class Registerteste:
    def __init__(self, frame_CadUserteste):
        self.frame_CadUserteste = frame_CadUserteste
        self.frame_CadUserteste = Frame(self.frame_CadUserteste, bg=bg_register, height=500, width=1000)
        self.frame_CadUserteste.pack(fill='both', expand=0)
        # Botões Usuários #
        self.bt_CadUser_Novo = Button(self.frame_CadUserteste, text="Novo", bd=2, bg='snow', fg='black')
        self.bt_CadUser_Novo.place(relx=0.915, rely=0.01, relwidth=0.08, relheight=0.04)               
        self.bt_CadUser_Editar = Button(self.frame_CadUserteste, text="Editar", bd=2, bg='snow', fg='black')
        self.bt_CadUser_Editar.place(relx=0.915, rely=0.05, relwidth=0.08, relheight=0.04)
        self.bt_CadUser_Salvar = Button(self.frame_CadUserteste, text="Salvar", bd=2, bg='snow', fg='black')
        self.bt_CadUser_Salvar.place(relx=0.915, rely=0.09, relwidth=0.08, relheight=0.04)
        self.bt_CadUser_Excluir = Button(self.frame_CadUserteste, text="Excluir", bd=2, bg='snow', fg='black')
        self.bt_CadUser_Excluir.place(relx=0.915, rely=0.13, relwidth=0.08, relheight=0.04)
        
        ## Dados Usuários ##
        self.dados_CadUser = ttk.Treeview(self.frame_CadUserteste, height=8, columns=("col1", "col2", "col3", "col4", "col5", "col6", "col7", "col8"))
        ...
        self.scroll_dados_CadUser = Scrollbar(self.frame_CadUserteste, orient='vertical')
        ...
        self.scroll_dados_CadUser = Scrollbar(self.frame_CadUserteste, orient='horizontal')
...
def __init__(self):
    ...
    self.frame_sec_CadEmp = Frame(bg=bg_register, height=1100, width=1400)
    self.frame_sec_CadFil = Frame(bg=bg_register, height=1100, width=1400)
    self.frame_sec_CadReg = Frame(bg=bg_register,height=1100, width=1400)
    self.frame_sec_CadCdc = Frame(bg=bg_register, height=1100, width=1400)
    self.frame_sec_CadCC = Frame(bg=bg_register, height=1100, width=1400)
