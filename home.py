...
class Home:
    def __init__(self, app):
        ...
        self.lb_Cometario.place(relx=0.52, rely=0.68, relheight=0.02)
        ...
        self.dados_analise.heading("#1", text="FL/CC")
        self.dados_analise.heading("#2", text="Filial/Centro de Custos")
        self.dados_analise.heading("#3", text="Red.")
        self.dados_analise.heading("#4", text="Descrição da Conta")
        self.dados_analise.heading("#5", text="Orçado Mensal")
        self.dados_analise.heading("#6", text="Realizado Mensal")
        self.dados_analise.heading("#7", text="Variação Mensal R$")
        self.dados_analise.heading("#8", text="Variação Mensal %")
        self.dados_analise.heading("#9", text="Total Ano Orçado")
        self.dados_analise.heading("#10", text="Acumulado Realizado")
        self.dados_analise.heading("#11", text="Saldo R$ Restante")
        self.dados_analise.heading("#12", text="Saldo % Restante")
        self.dados_analise.heading("#13", text="Situação")

        self.dados_analise.column("#0", width=1)
        self.dados_analise.column("#1", width=50)
        self.dados_analise.column("#2", width=200)
        self.dados_analise.column("#3", width=50)
        self.dados_analise.column("#4", width=250)
        self.dados_analise.column("#5", width=80)
        self.dados_analise.column("#6", width=80)
        self.dados_analise.column("#7", width=80)
        self.dados_analise.column("#8", width=80)
        self.dados_analise.column("#9", width=80)
        self.dados_analise.column("#10", width=80)
        self.dados_analise.column("#11", width=80)
        self.dados_analise.column("#12", width=80)
        self.dados_analise.column("#13", width=100)
        ...
        self.dados_lancamento.heading("#1", text="Data")
        self.dados_lancamento.heading("#2", text="Histórico")
        self.dados_lancamento.heading("#3", text="Valor")

        self.dados_lancamento.column("#0", width=1)
        self.dados_lancamento.column("#1", width=35)
        self.dados_lancamento.column("#2", width=350)
        self.dados_lancamento.column("#3", width=60)
